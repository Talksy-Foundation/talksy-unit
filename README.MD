...
```bash
sudo docker build -t talksy-unit:1.0.1 . && \
sudo docker run -p 8121:8080 -p 3478:3478/udp -p 3478:3478 -p 49152:65535/udp -p 49152:65535 -e TURN_ENABLED=TRUE -d talksy-unit:1.0.1
```
