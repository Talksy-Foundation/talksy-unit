...
> [!IMPORTANT]
> This library still in very early development. The API might change in the future. We use it in production for [Talksy](https://talksy.tuchacloud.ru). If you have any questions or find any issues, please write it to [this repo Github issue](https://github.com/Talksy-Foundation/sfu/issues). We will appreciate it.

# Talksy SFU

This Golang package is an SFU library based on Pion WebRTC. 
